# genpark-flaky-test-timing-non-determinism-detector-skill
...
<p align="center">
  <b>Production-Grade AI Code Review & Semantic Analysis Skill</b> • <b>100% Standard Library Python</b> • <b>Native Model Context Protocol (MCP)</b>
</p>
...
**genpark-flaky-test-timing-non-determinism-detector-skill** is a deterministic, zero-dependency Python skill engineered for autonomous AI code reviews, AST-level taint flow tracing, breaking API change audits, and test flakiness mitigation.

> **Executive Capability**: Automated test suite trace analyzer identifying timing races & state pollution (Datadog CI / Trunk)

### ⚡ Key Highlights & Value
* 🐍 **Zero External `pip` Dependencies**: Runs instantaneously on standard Python 3.9+ with zero environment bloat.
* 🔌 **Native Model Context Protocol (MCP)**: Seamlessly integrates into Claude Desktop, Cursor IDE, GitHub Actions PR bots, and autonomous developer workflows.
...
result = client.analyze_flaky_test_telemetry()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-flaky-test-timing-non-determinism-detector-skill": {
      "command": "python",
      "args": ["/path/to/genpark-flaky-test-timing-non-determinism-detector-skill/mcp_server.py"]
    }
  }
}
```
...
Explore the comprehensive directory of 1,200+ open-source, production-ready AI Agent skills at the [GenPark AI MCP Hub](https://genpark.ai/mcp) and learn more about developer productivity tools at [GenPark AI](https://genpark.ai).
